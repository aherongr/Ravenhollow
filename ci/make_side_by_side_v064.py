...
SAFE_ID = 'gr.ravenhollow.app.safe064'
...
g = re.sub(r'versionCode\s*=\s*\d+', 'versionCode = 6401', g)
g = re.sub(r'versionName\s*=\s*"[^"]+"', 'versionName = "0.6.4-safe4"', g)
...
m, label_n = re.subn(r'android:label="[^"]+"', 'android:label="Ravenhollow Safe 4"', m, count=1)
